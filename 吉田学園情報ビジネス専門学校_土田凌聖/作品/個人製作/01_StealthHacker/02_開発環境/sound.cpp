...
// パラメータの設定
const CSound::SOUNDPARAM CSound::m_aParam[] =
{
	...
	{ "Data/SE/wark.wav" , -1 },
	{ "Data/SE/shot.wav" , 0 },
	{ "Data/SE/getkey.wav" , 0 },
	{ "Data/SE/opendoor.wav" , 0 },
	{ "Data/SE/closedoor.wav" , 0 },
	{ "Data/SE/lock_door.wav" , 0 },
	{ "Data/SE/find.wav" , 0 },
	{ "Data/SE/hit.wav" , 0 },
	{ "Data/SE/start.wav" , 0 },
	{ "Data/SE/select.wav" , 0 },
	{ "Data/SE/openshutter.wav" , 0 },
	{ "Data/SE/goal.wav" , 0 },
};
...
//音量設定
//--------------------------------------
void CSound::SetVolume(SOUND_LABEL type, float fVolume)
{
	m_apSourceVoice[type]->SetVolume(fVolume);
}

void CSound::SetPitch(SOUND_LABEL label, float pith)
{
	m_apSourceVoice[label]->SetFrequencyRatio(pith);
}
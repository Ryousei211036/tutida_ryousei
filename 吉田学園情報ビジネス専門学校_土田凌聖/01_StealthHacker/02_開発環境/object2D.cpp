...
// ロゴのサイズの設定
//==============================================================================================
void CObject2D::SetLogoSize(float width, float height, float height2)
{
	m_fWidth = width;
	m_fWidth2 = width;
	m_fHeight = height;
	...
	m_fInitWidth = width;
	m_fInitWidth2 = width;
	m_fInitHeight = height;
	m_fInitHeight2 = height2;
}

//==============================================================================================
// サイズの加算
//==============================================================================================
void CObject2D::AddSize(float add, float max)
{
	if (m_fInitWidth + max > m_fWidth
		&& m_fInitWidth2 + max > m_fWidth2
		&& m_fInitHeight + max > m_fHeight
		&& m_fInitHeight2 + max > m_fHeight2)
	{
		m_fWidth += add;
		m_fWidth2 += add;
		m_fHeight += add;
